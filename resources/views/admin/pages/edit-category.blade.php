                ...
                <div class="widget-body form">
                    ...
                    <div class="control-group ">
                        ...
                        <div class="controls">
                            ...
                            <input class="span6 " id="firstname" value="{{$category_info->id}}" name="category_id" type="hidden" />
                        </div>
                    </div>
                    <div class="control-group ">
                        <label for="lastname"  class="control-label">Category Description</label>
                        <div class="controls">
                            <textarea class="span6 " value="" id="lastname" name="category_description">{{$category_info->category_description}}</textarea>
