        ...
        <div class="span12">
            ...
            <div class="widget green">
                ...
                <div class="widget-body form">
                    ...
                    {{--{{csrf_field()}}--}}
                    {!! Form::open(['url'=> '/save-blog','method'=>'post','enctype'=>'multipart/form-data' ,'class'=>'cmxform form-horizontal', 'id'=>'signupForm']) !!}
                    ...
                    <div class="control-group ">
                        ...
                        <div class="controls">
                            <select class="span6 " data-placeholder="Choose a Category" tabindex="-1" id="selXZ1" name="category_id" >
                                ...
                                @foreach($category_info as $v_vategory)
                                <option value="{{$v_vategory->id}}">{{$v_vategory->category_name}}</option>
                                    @endforeach
                    ...
                    <div class="control-group ">
                        ...
                        <div class="controls">
                            <textarea class="span6 " id="lastname" name="long_description"></textarea>
                    ...
                    <div class="control-group ">
                        ...
                        <div class="controls">
                            <textarea class="span6 " id="lastname" name="short_description"></textarea>
